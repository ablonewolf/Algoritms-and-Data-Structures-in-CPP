...
void placeItemAtIndex(int number, int firstHashedValue, int secondHashedValue, int collisionIndex, int hashTable[], int size)
{
...
int main()
{
  ...
  while (1)
  {
    ...
    if (option == 1)
    {
      ...
      {
        cout << "Cannot add more elements. Loading factor cannot exceed 0.5 when linear probing is applied." << endl;
      }
    }
    else if (option == 2)
    {
