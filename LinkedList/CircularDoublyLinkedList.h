...
// class for circular double-ended linked list, by default it will have two nodes, head and tail
...
public:
                ...
                if (isSortedAscending) {
                    ...
                    while (1) {
                        ...
                        if (tempNode->value > node->value) {
                            ...
                            // the new node's previous node will be the current tail of the list
                            // and it will be the next node of the current tail node
                            ...
                            // its next will be the current head as well as it will be the previous of the same node
                    ...
                    while (tempNode != nullptr) {
                        ...
                        if (tempNode->value < node->value) {
                            ...
                            // if we have reached the end of the list and value of the last node is not greater than that of the new node
                            // the new node will be the new tail of the list
                            // its next will be the current head as well as it will be the previous of the current head node
                            // and we will set the flag to indicate that the insertion is successful
                            if (tempNode == this->tail) {
                                tempNode->next = node;
                                node->prev = tempNode;
    ...
    bool removeNode(int value) {
        ...
        if (this->head == nullptr) {
            ...
            // the new head's previous will be the current tail
            // the current tail's next node will be the new head
                ...
                // we will start traversing from the next node of the head.
            {
                ...
                while (tempNode != this->head) {
                    ...
                    if (tempNode->value == value) {
                        ...
                        // as well as it will be the previous of the same node
        ...
        if (this->head == nullptr) {
            ...
            while (1) {
                ...
                if (tempNode->value == value) {
                    ...
                    // if reached, just checked whether it has the desired value
                    // here, we will break from the loop no matter the value equals to the searched value
    ...
    void reverseList() {
        ...
        while (1) {
            ...
            tempNode->prev = node;
            // if the next of current node is the current tail node, that next node will be the new head node
            if (tempNode->next == this->tail) {
                this->head = tempNode->next;
            }
            // if we encounter the new head
            // its previous node will be the new tail node
            // the new tail's next node will be the new head node
            ...
            if (tempNode == this->head) {
                ...
                // other than that, move to the new previous node of the current node
            else {
